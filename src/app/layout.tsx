...
export const metadata: Metadata = {
  ...
  description: "Get 10+ qualified leads per month on autopilot. Your business gets a professional website + AI that captures, qualifies, and WhatsApp-notifies you in 10 seconds.",
  keywords: ["lead generation", "South Africa SME", "AI website", "WhatsApp leads", "CRM", "NahaLabs"],
  authors: [{ name: "NahaLabs" }],
  openGraph: { title: "Lead Machine — AI Lead Generation", description: "Your business gets a website that turns visitors into paying clients while you sleep.", siteName: "Lead Machine", type: "website" },
};
